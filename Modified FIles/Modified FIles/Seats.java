...
public class Seats extends Database{
    ...
    public void addTicketInfo(String seatNumber, String movieName, String showTime, String price) {

        String sql = "INSERT INTO ticketinfo (seat, movieBought, showTime, price) VALUES (?,?,?,?)";
    ...
    private class movieListener implements ActionListener {    // When a movie is chosen
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getActionCommand().equals("PAY")){     // When PAY button is clicked
                ...
                addTicketInfo(totalSeats, selectedMovie, selectedShowtime, amountPrice);
            }
        }
    }
